...
public class HostTest {
    ...
    public void testHost() throws Exception {
        ...
        Assertions.assertEquals(callCount, host.getTotalConnections());
        Assertions.assertEquals(0, host.getTotalErrors());
        Assertions.assertEquals(0, host.getConsecutiveErrors());
        Assertions.assertEquals(0, host.getOpenConnections());
        Assertions.assertEquals(0, host.getResponseIndex());

        // test open connections
        host.connectionOpened();
        host.connectionOpened();

        Assertions.assertEquals(2, host.getOpenConnections());
        Assertions.assertEquals(2, host.getResponseIndex());
        ...
        Assertions.assertEquals(0, host.getResponseIndex());
        Assertions.assertFalse(host.isHealthy()); // host should enter cool down period for error

        Thread.sleep(errorWaitTime - 500); // wait until just before the error is cooled down
        Assertions.assertFalse(host.isHealthy()); // host should still be in cool down period
        ...
        Assertions.assertEquals(0, host.getOpenConnections());
        Assertions.assertEquals(2, host.getConsecutiveErrors());
        Assertions.assertEquals(2, host.getTotalErrors());
        Assertions.assertEquals(0, host.getResponseIndex());
        ...
        Assertions.assertEquals(0, host.getOpenConnections());
        Assertions.assertEquals(3, host.getConsecutiveErrors());
        Assertions.assertEquals(3, host.getTotalErrors());
        Assertions.assertEquals(0, host.getResponseIndex());
        Assertions.assertFalse(host.isHealthy());
        ...
        Assertions.assertEquals(0, host.getConsecutiveErrors());
        Assertions.assertEquals(3, host.getTotalErrors());
        Assertions.assertEquals(callCount + 5, host.getTotalConnections());
        Assertions.assertEquals(0, host.getResponseIndex());
        Assertions.assertTrue(host.isHealthy());
    }
    ...
    public void testErrorWaitLimit() throws Exception {
        ...
        Assertions.assertEquals(errors, host.getConsecutiveErrors());
